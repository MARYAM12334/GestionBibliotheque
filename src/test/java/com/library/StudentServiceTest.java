...
class StudentServiceTest {
    ...
    void testAddStudent() {
        ...
        int studentId = students.get(0).getId(); // Récupérer l'ID de l'étudiant ajouté
        assertEquals("Alice", studentDAO.getStudentById(studentId).getName(), "Le nom de l'étudiant ajouté ne correspond pas");
    }
    @Test
    ...
    void testDeleteStudent() {
        ...
        System.out.println("Student normalement Trouver "+studentService.findStudentById(3));
        studentService.deleteStudent(3);
        System.out.println("Student normalement deleted");
